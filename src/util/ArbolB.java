...
public class ArbolB<T> {
     ...
     *
     * @param raiz un tipo NodoB<T> , almacena la dirección de memoria de un
     ...
     *
     * @return un tipo de objeto de la clase Nodo con la dirección de
    ...
    /**
     * Devuelve una copia del árbol. Los elementos almacenados no se copian,
     * solo la estructura morfológica del árbol.
     *
