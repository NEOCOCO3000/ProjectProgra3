...
public class ArbolExpresionGrafico<T> extends JPanel 
{
     ...
     * dibujar.
     */
    public ArbolExpresionGrafico(ArbolB<T> miArbol) 
    {
    ...
    private void calcularPosiciones() 
    {
         posicionNodos.clear();
         subtreeSizes.clear();
         NodoB<T> root = this.miArbol.getRaiz();
         if (root != null) 
         {
     ...
     */
    private Dimension calcularTamañoSubarbol(NodoB<T> n) 
    {
          if (n == null) 
     ...
     */
    private void calcularPosicion(NodoB<T> n, int left, int right, int top) 
    {
      if (n == null) 
          return;
      ...
      int width = fm.stringWidth(n.getInfo().toString());
     ...
     */
    private void dibujarArbol(Graphics2D g, NodoB<T> n, int puntox, int puntoy, int yoffs) 
    {
     if (n == null) 
         return;
     ...
     g.draw(r);
     g.drawString(n.getInfo().toString(), r.x + 3, r.y + yoffs);
